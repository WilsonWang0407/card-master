...
/**
 * This is a representation of a Silverguard Knight creature.
 * The creature card has a unique ID. The creature card has a 
 * set mana cost, attack, and health. Silverguard Knight has the 
 * Provoke ability and the Zeal ability. It moves and attacks 
 * according to the methods set in Unit. 
 *
 */
...
public class SilverguardKnight extends Unit {
    ...
    public SilverguardKnight() {
        ...
        this.health = 5;
        this.maxHealth = 5;
        this.config = StaticConfFiles.silverguardKnight;
    }
