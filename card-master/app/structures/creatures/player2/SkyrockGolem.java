...
/**
 * This is a representation of a Skyrock Golem creature.
 * The creature card has a unique ID. The creature card has a 
 * set mana cost, attack, and health. Skyrock Golem has no abilities.
 * It moves and attacks according to the methods set in Unit. 
 *
 */
...
public class SkyrockGolem extends Unit {
    ...
    public SkyrockGolem() {
        ...
        this.health = 2;
        this.maxHealth = 2;
        this.config = StaticConfFiles.skyrockGolem;
    }
