...
/**
 * This is a representation of a Young Flamewing creature.
 * The creature card has a unique ID. The creature card has a 
 * set mana cost, attack, and health. Young Flamewing has the
 * Flying ability. It attacks according to the method set in Unit,
 * but its movement method is overridden to match its ability. 
 *
 */
...
public class YoungFlamewing extends Unit {
    ...
    public YoungFlamewing() {
        ...
        this.health = 4;
        this.maxHealth = 4;
        this.config = StaticConfFiles.youngFlamwing;
    }
